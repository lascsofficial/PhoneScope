...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
     ...
     */
    public VicoLibraryAccessors getVico() { return laccForVicoLibraryAccessors; }
    ...
    public static class ComposeLibraryAccessors extends SubDependencyFactory {
        private final ComposeGoogleLibraryAccessors laccForComposeGoogleLibraryAccessors = new ComposeGoogleLibraryAccessors(owner);
        ...
        /**
         * Returns the group of libraries at compose.google
         */
        public ComposeGoogleLibraryAccessors getGoogle() { return laccForComposeGoogleLibraryAccessors; }
    ...
    public static class ComposeGoogleLibraryAccessors extends SubDependencyFactory {

        public ComposeGoogleLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for fonts (androidx.compose.ui:ui-text-google-fonts)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getFonts() { return create("compose.google.fonts"); }
    ...
    public static class GlanceLibraryAccessors extends SubDependencyFactory {
        ...
        public GlanceLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getAppwidget() { return create("glance.appwidget"); }

            /**
             * Creates a dependency provider for material3 (androidx.glance:glance-material3)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getMaterial3() { return create("glance.material3"); }
    ...
    public static class VicoLibraryAccessors extends SubDependencyFactory {
        ...
        public VicoLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCompose() { return create("vico.compose"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: coil (3.0.4)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: glance (1.1.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: vico (2.0.0-beta.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class ComposeVersionAccessors extends VersionFactory  {
        ...
        public ComposeVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: compose.navigation (2.8.5)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class GoogleVersionAccessors extends VersionFactory  {
        ...
        public GoogleVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: google.fonts (1.7.5)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class JunitVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        public Provider<String> asProvider() { return getVersion("junit"); }
            ...
            /**
             * Returns the version associated to this alias: junit.ext (1.2.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
